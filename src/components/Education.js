      ...
      <h3><strong>Education</strong></h3> 
        <div class="timeline">
            ...
            <div class="timeline-item">
              <h4 class="item-title">Professional Year Program (Computer Science)</h4>
            ...
            <div class="timeline-item">
              ...
              <span class="item-small">University of Canberra.</span>
              <p class="item-description">HTML, CSS, JavaScript, Web Design</p>
            </div>
                ...
                <div class="timeline">
                  {/* Experience 4 */}
                    <div class="timeline-item">
                      ...
                      <p class="item-description">ReactJS, HTML, CSS, GIT, Node.js, AWS</p>
                    </div>
                    ...
                    <div class="timeline-item">
                      ...
                      <span class="item-small">Pepper Lunch Restaurant(Canberra)</span>
                      <p class="item-description">Set budgets and execute plans for department sales,
                        <br/>product purchase and staff development,
                        <br/>scheduling shifts</p>
                    </div>
